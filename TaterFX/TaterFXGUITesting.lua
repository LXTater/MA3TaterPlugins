...
-- Create a table of SpeedMaster display names mapped to their indices
local values = {}
local speedMasters = ShowData().Masters.Speed
local i = 1
while speedMasters[i] do
    values['SpeedMaster ' .. i] = i
    i = i + 1
end

-- Define the swipe menu selector with the populated values
selectors = {{
    name = 'Swipe Selector',
    selectedValue = 1,
    type = 0,
